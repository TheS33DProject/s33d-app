...
import { useGetS33DBalance } from 'hooks/useTokenBalance'
...
const EventStepsSection: React.FC<EventStepsProps> = ({ eventInfos, userInfos, isLoading, userStatus, account }) => {
  ...
  const { balance: s33dBalance } = useGetS33DBalance()
  const stepsConfig = stepsConfigBuilder({ t, eventInfos, userInfos, userStatus, account, theme, s33dBalance })
