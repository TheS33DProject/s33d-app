...
import BuySeedScreen from 'views/BuySeeds'
import DisclamerScreen from 'views/DisclamerPage'
import WhiteListingScreen from 'views/WhiteListing'
import ThankYouScreen from 'views/ThankYouPage'
import PurchaseSeeds from 'views/PurchaseSeeds'
